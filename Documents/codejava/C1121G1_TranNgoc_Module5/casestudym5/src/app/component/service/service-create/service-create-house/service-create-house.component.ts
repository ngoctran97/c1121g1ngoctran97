...
@Component({
  selector: 'app-service-create-house',
  templateUrl: './service-create-house.component.html',
  styleUrls: ['./service-create-house.component.css']
})
export class ServiceCreateHouseComponent implements OnInit {
